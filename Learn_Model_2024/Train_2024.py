...
reports_dir = os.path.join(script_dir, "Model_2024_Output", "reports")
...
# ---------------------------------------------------
print("\n📥 Loading data...")
features_path = os.path.join(script_dir, "Features_Output", "extracted_features_2024.pkl")
labels_path = os.path.join(script_dir, "Features_Output", "extracted_labels_2024.pkl")
...
sys.path.append(os.path.join(os.path.dirname(script_dir), 'Changed_Solution'))
from Changed_feature_extractor import ChangedURLFeatureExtractor as URLFeatureExtractor
...
# ---------------------------------------------------
print("\n💾 Saving model files...")
model_dir = os.path.join(script_dir, "Model_2024_Output")
