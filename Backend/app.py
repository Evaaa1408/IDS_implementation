#API for Browser Extension - Rule-Based Fusion System
from flask import Flask, request, jsonify, send_file
from flask_cors import CORS
import os
import sys

# Add parent directory to path to import the ensemble predictor
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '..')))
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '../Changed_Solution')))

from Changed_Solution.Ensemble_Rulebased import RuleBasedFusionPredictor
...
def home():
    return jsonify({
        "status": "running", 
        "model": "Rule-Based Fusion (Model 2024 + Model 2023)",
        "framework": "Flask",
...
if __name__ == "__main__":
    ...
    print("   • Models: Model 2024 (URL) + Model 2023 (Content)")
    print("   • Port: 5000")
    print("   • CORS: Enabled")
    print("\n🌐 Endpoints:")
