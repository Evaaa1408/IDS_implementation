...
import pandas as pd
from Changed_feature_extractor import ChangedURLFeatureExtractor
import joblib
import os
...
# ========================================================
print(f"\n💾 Saving files...")
joblib.dump(features_df, "Models/2025/features_2025.pkl")
joblib.dump(labels, "Models/2025/labels_2025.pkl")

print(f"✅ Saved: Models/2025/features_2025.pkl (shape: {features_df.shape})")
print(f"✅ Saved: Models/2025/labels_2025.pkl (length: {len(labels)})")
